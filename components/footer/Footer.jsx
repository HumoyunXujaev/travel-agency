    ...
    <footer className="border-t border-gray-400 bg-gray-100">
      ...
      >
        ...
        <div className="flex justify-center mt-4 lg:mt-0">
          <a className="lg:mr-3" href="https://github.com/HumoyunXujaev">
            <svg
          ...
          <a className="ml-3 lg:mr-3" href="mailto:hujaevhumoyun01@gmail.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="35"
              height="35"
      ...
      <div className="flex justify-center align-center text-center mb-3">
        <p className="text-md text-red-500 font-semibold mb-2">
          Copyright © 2023 by{" "}
          <a className="text-blue-400" href="mailto:hujaevhumoyun01@gmail.com">
            Humoyun Hujaev
          </a>{" "}
          . All Rights Reserved.
        </p>{" "}
